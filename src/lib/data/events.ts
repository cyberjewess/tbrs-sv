...
// Generated by scripts/db-to-static-events.ts from /Users/estilurie/terminal/projects/tbrs-sv/data/tbrs.db on 2025-09-24T19:27:22.979Z.

import type { Event } from '../types';

export const events: Event[] = [
  { date: '0000-01-01', title: '1 Tishrei 1 ~ Creation of the Universe', isMystical: true, hideDate: true },
  { date: '0001-01-02', title: '9 Av 3338 ~ Destruction of the First Temple', isMystical: true, hideDate: true },
  { date: '0070-08-02', title: '9 Av 3830 ~ Destruction of the Second Temple', isMystical: true, externalLink: 'https://www.chabad.org/library/article_cdo/aid/2641925/jewish/Which-Year-Was-the-Second-Temple-Destroyed-69-CE-or-70-CE.htm', hideDate: true },
  ...
  { date: '2025-03-13', title: 'Purim begins, JFREJ full megillah reading', externalLink: 'https://www.jfrej.org/events/2025/01/jfrej-purim-project-%CC%B6e%CC%B6s%CC%B6t%CC%B6h%CC%B6e%CC%B6r%CC%B6-vashti' },
  ...
  { date: '2025-10-02', title: 'Yom Kippur services', description: 'Eilah Atah begins at 8:30am.', isHeadline: true },
  { date: '2025-10-05', title: 'Sukkah build @ Esti', description: 'Bagels, lox, & coffee at 10:30am.', isHeadline: true },
  { date: '2025-10-06', title: 'Erev Sukkot' },
  { date: '2025-10-08', title: 'Art night in the Sukkah', description: 'Crafting begins at 6:00pm.', isHeadline: true },
  { date: '2025-10-10', title: 'Shabbos in the Sukkah @ Esti', description: 'Services @ 6:30pm. Potluck dinner by 8:00pm.', isHeadline: true },
